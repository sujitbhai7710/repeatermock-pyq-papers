...
_generated 2026-09-12T01:10:26Z_
...
- recorded: 2026-09-12T01:10:26Z
- route health last updated: 2026-09-11T21:06:13Z
...
- last checkpoint at: 2026-09-11T21:06:13Z
- cursor: `{'completed': ['phase0', 'phase1', 'phase2', 'phase3', 'phase4', 'phase5'], 'next': None, 'verify': {'phase': 'phase1', 'batch': 0, 'batches_done': 0, 'items_done': 0, 'items_total': 1, 'state_file': 'state/verify_state.json', 'started_wall': '2026-09-11T21:06:13Z'}}`

## Phases (work items)

| Phase | Status | Items | Done | % | This run | Remaining | ETA | Updated |
|---|---|---:|---:|---:|---:|---:|---:|---|
| `phase0` | ok | 142,090 | 142,090 | 100.0% | 142,090 | 0 | 0s | 2026-09-11T21:10:30Z |
| `phase1` | ai_unavailable | 1 | 0 | 0.0% | 0 | 1 | - | 2026-09-11T21:06:13Z |
...
## Provider health (per provider + model, 2026-09-11T21:06:13Z)

| Route | State | OK | Fail | Rate-limited | Trips | Cooldown | Retry in | Last reason |
|---|---|---:|---:|---:|---:|---:|---:|---|
| `agentrouter/deepseek-v4-flash` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `agentrouter/deepseek-v4.1-flash:free` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `agentrouter/gpt-5.6-sol` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `ar-worker/deepseek-v4-flash` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `ar-worker/deepseek-v4.1-flash:free` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `ar-worker/gpt-5.6-sol` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `justwoker/deepseek-v4-flash` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `justwoker/deepseek-v4.1-flash:free` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `justwoker/gpt-5.6-sol` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `jw-worker/deepseek-v4-flash` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `jw-worker/deepseek-v4.1-flash:free` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `jw-worker/gpt-5.6-sol` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `tokenharbor/deepseek-v4-flash` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `tokenharbor/deepseek-v4.1-flash:free` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `tokenharbor/gpt-5.6-sol` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `zen-rotator/deepseek-v4-flash` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `zen-rotator/deepseek-v4.1-flash:free` | closed | 0 | 1 | 1 | 0 | - | - | - |
| `zen-rotator/gpt-5.6-sol` | closed | 0 | 1 | 1 | 0 | - | - | - |
